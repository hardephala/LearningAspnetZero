...
using Arch.MultiTenancy.HostDashboard;
...
namespace Arch.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ArchDbContext context, SubscriptionPayment subscriptionPayment)
        {
