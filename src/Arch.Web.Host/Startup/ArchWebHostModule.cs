...
using Arch.Auditing;
using Arch.Authorization.Users.Password;
using Arch.Configuration;
using Arch.EntityFrameworkCore;
using Arch.MultiTenancy;
using Arch.Web.Startup.ExternalLoginInfoProviders;
...
namespace Arch.Web.Startup
{
    ...
    public class ArchWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ArchWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ArchWebHostModule).GetAssembly());
        }
