...
namespace Arch.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var erInvoiceDatas = pages.CreateChildPermission(AppPermissions.Pages_ErInvoiceDatas, L("ErInvoiceDatas"));
            erInvoiceDatas.CreateChildPermission(AppPermissions.Pages_ErInvoiceDatas_Create, L("CreateNewErInvoiceData"));
            erInvoiceDatas.CreateChildPermission(AppPermissions.Pages_ErInvoiceDatas_Upload, L("UploadErInvoiceData"));
            erInvoiceDatas.CreateChildPermission(AppPermissions.Pages_ErInvoiceDatas_Edit, L("EditErInvoiceData"));
            erInvoiceDatas.CreateChildPermission(AppPermissions.Pages_ErInvoiceDatas_Delete, L("DeleteErInvoiceData"));

            var invoicedatas = pages.CreateChildPermission(AppPermissions.Pages_Invoicedatas, L("Invoicedatas"));
            invoicedatas.CreateChildPermission(AppPermissions.Pages_Invoicedatas_Create, L("CreateNewInvoicedata"));
            invoicedatas.CreateChildPermission(AppPermissions.Pages_Invoicedatas_Edit, L("EditInvoicedata"));
            invoicedatas.CreateChildPermission(AppPermissions.Pages_Invoicedatas_Delete, L("DeleteInvoicedata"));

            var longstandings = pages.CreateChildPermission(AppPermissions.Pages_Longstandings, L("Longstandings"));
            longstandings.CreateChildPermission(AppPermissions.Pages_Longstandings_Create, L("CreateNewLongstanding"));
            longstandings.CreateChildPermission(AppPermissions.Pages_Longstandings_Edit, L("EditLongstanding"));
            longstandings.CreateChildPermission(AppPermissions.Pages_Longstandings_Delete, L("DeleteLongstanding"));
            ...
            var donotreleases = pages.CreateChildPermission(AppPermissions.Pages_Donotreleases, L("Donotreleases"));
            donotreleases.CreateChildPermission(AppPermissions.Pages_Donotreleases_Create, L("CreateNewDonotrelease"));
            donotreleases.CreateChildPermission(AppPermissions.Pages_Donotreleases_Edit, L("EditDonotrelease"));
            donotreleases.CreateChildPermission(AppPermissions.Pages_Donotreleases_Delete, L("DeleteDonotrelease"));

            var cargoreleases = pages.CreateChildPermission(AppPermissions.Pages_Cargoreleases, L("Cargoreleases"));
            cargoreleases.CreateChildPermission(AppPermissions.Pages_Cargoreleases_Create, L("CreateNewCargorelease"));
            cargoreleases.CreateChildPermission(AppPermissions.Pages_Cargoreleases_Edit, L("EditCargorelease"));
            cargoreleases.CreateChildPermission(AppPermissions.Pages_Cargoreleases_Delete, L("DeleteCargorelease"));

            var billofladings = pages.CreateChildPermission(AppPermissions.Pages_Billofladings, L("Billofladings"));
            billofladings.CreateChildPermission(AppPermissions.Pages_Billofladings_Create, L("CreateNewBilloflading"));
            billofladings.CreateChildPermission(AppPermissions.Pages_Billofladings_Edit, L("EditBilloflading"));
            billofladings.CreateChildPermission(AppPermissions.Pages_Billofladings_Delete, L("DeleteBilloflading"));
