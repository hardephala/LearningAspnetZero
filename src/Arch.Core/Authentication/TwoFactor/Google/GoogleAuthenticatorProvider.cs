...
namespace Arch.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ArchServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Arch", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
