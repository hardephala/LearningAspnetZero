...
{
    public class SubscriptionPaymentRepository : ArchRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ArchDbContext> dbContextProvider)
