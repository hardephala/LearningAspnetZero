...
{
    public class SubscriptionPaymentExtensionDataRepository : ArchRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ArchDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
