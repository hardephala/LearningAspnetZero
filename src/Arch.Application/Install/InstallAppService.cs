...
namespace Arch.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ArchAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ArchDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ArchConsts.ConnectionStringName}", constring);
        }
