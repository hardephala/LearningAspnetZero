...
{
    public class SessionAppService : ArchAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ArchConsts.Currency,
                        CurrencySign = ArchConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ArchConsts.AllowTenantsToChangeEmailSettings,
