...
using EntityHistoryHelper = Arch.EntityHistory.EntityHistoryHelper;

namespace Arch.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ArchAppServiceBase, IAuditLogAppService
    {
