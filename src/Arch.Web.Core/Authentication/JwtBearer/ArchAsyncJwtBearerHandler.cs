...
{
    public class ArchAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public ArchAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
