...
namespace Arch.Web.Public.Startup
{
    [DependsOn(
        typeof(ArchWebCoreModule)
    )]
    public class ArchWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ArchWebFrontEndModule(IWebHostEnvironment env, ArchEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ArchWebFrontEndModule).GetAssembly());
        }
    }
}
